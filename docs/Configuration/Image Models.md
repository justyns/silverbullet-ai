...
An image model is configured in Space Lua like this, very similar to the [[Configuration/Text Models]]:
...
- **useProxy**: If false, bypasses SilverBullet's proxy and makes requests directly. Defaults to true.
