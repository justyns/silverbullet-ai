...
This page lists AI models and their compatibility with silverbullet-ai features, particularly tool/function calling, streaming, and structured responses.
...
| Model | Provider | Tool Calling | Benchmark | Notes |
|-------|----------|--------------|-----------|-------|
